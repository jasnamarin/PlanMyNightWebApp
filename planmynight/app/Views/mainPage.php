...
<body onload="mapViewOnLoad()">
    ...
    <div class="container-fluid">
        <a href="javascript:void(0);"><img src="PlanMyNightPics/menu-logo.png" id="user-info-logo" alt="" class="menu-logo" onclick="showUserInfo()"></a>
        ...
        <div class="col-sm-4 offset-8 user-info" id="user-info">
            <div class="card card-block user-card">
                ...
                <h1>Filip Andric</h1>
                <br>
                <a href="javascript:void(0);" class="nav-link-user">My plans</a>
                <br>
                <a href="javascript:void(0);" class="nav-link-user">Preferences</a>
                <br>
                <a href="myRatings.html" class="nav-link-user">Ratings</a>
                <br>
                <a href="myPlaces.html" class="nav-link-user">My places</a>
                <a href="javascript:void(0);"><img src="PlanMyNightPics/back-arrow.png" alt="" class="back" style="margin-top: 150px;" onclick="hideUserInfo()"></a>
            </div>
        </div>
